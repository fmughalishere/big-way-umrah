        ...
        <div className="flex flex-col gap-10 items-center">
          ...
          >
            <div className="space-y-2">
              <h1 className="text-4xl md:text-5xl font-black tracking-tighter leading-none" style={{ color: blueColor }}>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-7xl mx-auto pt-4 text-left">
              {[
                { icon: <Phone size={20} />, label: "Call Us",   val: "+92 317 317 6483",          href: "tel:+923173176483" },
                ...
                <a
                  href={item.href}
                  key={idx}
                  className="flex items-center gap-4 p-3 bg-slate-50 rounded-2xl border border-slate-100 hover:shadow-md transition-all group w-full"
                >
                  <div
                    className="w-12 h-12 bg-white rounded-xl flex items-center justify-center shrink-0 group-hover:text-white transition-all duration-300"
          ...
          >
            <div className="relative z-10">
              <div className="text-center mb-8">
                ...
                <h2 className="text-lg font-black tracking-widest uppercase" style={{ color: blueColor }}>Plan Your Sacred Journey</h2>
              </div>
              ...
              <form onSubmit={handleSubmit(onSubmit)} className="space-y-5">
                <div className="space-y-1">
                  ...
                  <input {...register("fullName", { required: true })} placeholder="Enter your full name"
                    className="w-full p-4 rounded-2xl bg-white border border-slate-200 outline-none focus:ring-2 focus:ring-[#3b5998] font-bold text-sm" />
                </div>
                <div className="space-y-1">
                  <label className="text-[10px] font-black uppercase tracking-widest ml-2 text-slate-400">WhatsApp No. *</label>
                  <input {...register("whatsapp", { required: true })} placeholder="+92 3XX XXX XXXX"
                    className="w-full p-4 rounded-2xl bg-white border border-slate-200 outline-none focus:ring-2 focus:ring-[#3b5998] font-bold text-sm" />
                </div>
                <div className="space-y-1">
                ...
                <div className="space-y-1">
                  ...
                  <input type="number" {...register("adults")} placeholder="0"
                    className="w-full p-4 rounded-2xl bg-white border border-slate-200 outline-none font-bold text-sm focus:ring-2 focus:ring-[#3b5998]" />
                </div>
                <div className="space-y-1">
                  <label className="text-[10px] font-black uppercase tracking-widest ml-2 text-slate-400">No. of Kids</label>
                  <input type="number" {...register("kids")} placeholder="0"
                    className="w-full p-4 rounded-2xl bg-white border border-slate-200 outline-none font-bold text-sm focus:ring-2 focus:ring-[#3b5998]" />
                </div>
                <div className="space-y-1">
                  ...
                  <input type="date" {...register("arrivalDate")}
                    className="w-full p-4 rounded-2xl bg-white border border-slate-200 outline-none font-bold text-sm text-slate-400 focus:ring-2 focus:ring-[#3b5998]" />
                </div>
                <div className="space-y-1">
                ...
                <div className="space-y-1">
                  ...
                  <select {...register("departureAirport", { required: true })}
                    className="w-full p-4 rounded-2xl bg-white border border-slate-200 outline-none focus:ring-2 focus:ring-[#3b5998] font-bold text-sm text-slate-500">
                    <option value="">Select Departure Airport</option>
                    <option value="Lahore — Allama Iqbal International (LHE)">Lahore — Allama Iqbal International (LHE)</option>
                    <option value="Islamabad — Islamabad International (ISB)">Islamabad — Islamabad International (ISB)</option>
                    <option value="Karachi — Jinnah International (KHI)">Karachi — Jinnah International (KHI)</option>
                    <option value="Peshawar — Bacha Khan International (PEW)">Peshawar — Bacha Khan International (PEW)</option>
                    <option value="Multan — Multan International (MUX)">Multan — Multan International (MUX)</option>
                    <option value="Quetta — Quetta International (UET)">Quetta — Quetta International (UET)</option>
                  </select>
                </div>
                <div className="space-y-1">
                  <label className="text-[10px] font-black uppercase tracking-widest ml-2 text-slate-400">Arrival Airport (Saudi Arabia) *</label>
                  <select {...register("arrivalAirport", { required: true })}
                    className="w-full p-4 rounded-2xl bg-white border border-slate-200 outline-none focus:ring-2 focus:ring-[#3b5998] font-bold text-sm text-slate-500">
                    ...
                    <option value="Madinah — Prince Mohammad bin Abdulaziz (MED)">Madinah — Prince Mohammad bin Abdulaziz (MED)</option>
                    <option value="Riyadh — King Khalid International (RUH)">Riyadh — King Khalid International (RUH)</option>
                  </select>
                </div>
                <button
                  type="submit"
